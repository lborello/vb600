VERSION 5.00
Begin VB.UserControl ctlRemito_Operacion 
   ClientHeight    =   375
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4635
   ScaleHeight     =   375
   ScaleWidth      =   4635
   Begin VB.ComboBox cboRemitoOperacion 
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
      ...
      EndProperty
      Height          =   360
      ItemData        =   "ctlRemito_Operacion.ctx":0000
      Left            =   540
      List            =   "ctlRemito_Operacion.ctx":000A
      Style           =   2  'Dropdown List
      TabIndex        =   0
      Top             =   0
      Width           =   4095
   End
   Begin VB.Label lblRemitoOperacion 
      Alignment       =   2  'Center
   ...
   End
End
Attribute VB_Name = "ctlRemito_Operacion"
...
Dim m_Valor As Remito_Operacion
'Event Declarations:
Event Click()
...
Private Sub cboRemitoOperacion_Click()
 If cboRemitoOperacion.ListIndex <> -1 Then
    lblRemitoOperacion.Caption = cboRemitoOperacion.ItemData(cboRemitoOperacion.ListIndex)
    m_Valor = cboRemitoOperacion.ItemData(cboRemitoOperacion.ListIndex)
  Else
    lblRemitoOperacion.Caption = ""
    m_Valor = OperacionNulo
...
Public Property Let Enabled(ByVal New_Enabled As Boolean)
    ...
    cboRemitoOperacion.Enabled = m_Enabled
...
Public Property Set Font(ByVal New_Font As Font)
    Set m_Font = New_Font
    cboRemitoOperacion.Font = Font
    lblRemitoOperacion.Font = Font
...
'ADVERTENCIA: NO QUITAR NI MODIFICAR LAS SIGUIENTES LINEAS CON COMENTARIOS
'MemberInfo=7,0,0,0
Public Property Get Valor() As Remito_Operacion
    Valor = m_Valor
End Property

Public Property Let Valor(ByVal New_Valor As Remito_Operacion)
    m_Valor = New_Valor
   If m_Valor = OperacionNulo Then
        lblRemitoOperacion.Caption = ""
        cboRemitoOperacion.ListIndex = -1
   Else
        lblRemitoOperacion.Caption = m_Valor
        cboRemitoOperacion.ListIndex = m_Valor
   End If
...
Private Sub UserControl_Resize()
     cboRemitoOperacion.Width = UserControl.Width - lblRemitoOperacion.Width
End Sub
