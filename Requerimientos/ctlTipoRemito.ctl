VERSION 5.00
Begin VB.UserControl ctlTipoRemito 
   ClientHeight    =   390
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4620
   ...
   Begin VB.ComboBox cboTipoRemito 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "ctlTipoRemito.ctx":0000
      Left            =   540
      List            =   "ctlTipoRemito.ctx":0013
      Style           =   2  'Dropdown List
      TabIndex        =   1
      Top             =   0
      Width           =   4095
   End
   Begin VB.Label lblTipoRemito 
      Alignment       =   2  'Center
   ...
   End
End
Attribute VB_Name = "ctlTipoRemito"
...
Public Property Let Enabled(ByVal New_Enabled As Boolean)
    ...
    cboTipoRemito.Enabled = m_Enabled
    PropertyChanged "Enabled"
End Property

'ADVERTENCIA: NO QUITAR NI MODIFICAR LAS SIGUIENTES LINEAS CON COMENTARIOS
'MappingInfo=cboTipoRemito,cboTipoRemito,-1,Font
Public Property Get Font() As Font
Attribute Font.VB_Description = "Devuelve un objeto Font."
Attribute Font.VB_UserMemId = -512
    Set Font = cboTipoRemito.Font
End Property

Public Property Set Font(ByVal New_Font As Font)
    Set cboTipoRemito.Font = New_Font
...
'ADVERTENCIA: NO QUITAR NI MODIFICAR LAS SIGUIENTES LINEAS CON COMENTARIOS
'MemberInfo=14,0,0,0
Public Property Get Valor() As Tipo_Remito
    Valor = m_Valor
End Property

Public Property Let Valor(ByVal New_Valor As Tipo_Remito)
    m_Valor = New_Valor
    PropertyChanged "Valor"
    
    If New_Valor = TipoNulo Then
        cboTipoRemito.ListIndex = -1
        lblTipoRemito.Caption = ""
    Else
        cboTipoRemito.ListIndex = New_Valor
        lblTipoRemito.Caption = New_Valor
    End If
End Property

Private Sub cboTipoRemito_Click()
    If cboTipoRemito.ListIndex <> -1 Then
        m_Valor = cboTipoRemito.ItemData(cboTipoRemito.ListIndex)
        lblTipoRemito.Caption = cboTipoRemito.ItemData(cboTipoRemito.ListIndex)
        RaiseEvent Click
     Else
        m_Valor = TipoNulo
        lblTipoRemito.Caption = ""
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    Set cboTipoRemito.Font = PropBag.ReadProperty("Font", Ambient.Font)
...
Private Sub UserControl_Resize()
    cboTipoRemito.Width = UserControl.Width - lblTipoRemito.Width
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("Font", cboTipoRemito.Font, Ambient.Font)
