VERSION 5.00
Begin VB.UserControl ctlRemitoEstado 
   ClientHeight    =   375
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4635
   ScaleHeight     =   375
   ScaleWidth      =   4635
   Begin VB.ComboBox cboRemitoEstado 
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
      ...
      EndProperty
      Height          =   360
      ItemData        =   "ctlRemitoEstado.ctx":0000
      Left            =   540
      List            =   "ctlRemitoEstado.ctx":000A
      Style           =   2  'Dropdown List
      TabIndex        =   0
      Top             =   0
      Width           =   4095
   End
   Begin VB.Label lblRemitoEstado 
      Alignment       =   2  'Center
   ...
   End
End
Attribute VB_Name = "ctlRemitoEstado"
...
Dim m_Valor As Remito_Estado
'Event Declarations:
Event Click() 'MappingInfo=cboRemitoEstado,cboRemitoEstado,-1,Click
...
Private Sub cboRemitoEstado_Click()
    RaiseEvent Click
 If cboRemitoEstado.ListIndex <> -1 Then
    lblRemitoEstado.Caption = cboRemitoEstado.ItemData(cboRemitoEstado.ListIndex)
    m_Valor = cboRemitoEstado.ItemData(cboRemitoEstado.ListIndex)
  Else
    lblRemitoEstado = ""
    m_Valor = EstadoNulo
  End If
...
Private Sub UserControl_Resize()
    cboRemitoEstado.Width = UserControl.Width - lblRemitoEstado.Width
End Sub
...
Public Property Let Enabled(ByVal New_Enabled As Boolean)
    ...
    cboRemitoEstado.Enabled = m_Enabled
...
Public Property Set Font(ByVal New_Font As Font)
    Set m_Font = New_Font
    Set cboRemitoEstado.Font = m_Font
...
'ADVERTENCIA: NO QUITAR NI MODIFICAR LAS SIGUIENTES LINEAS CON COMENTARIOS
'MemberInfo=7,0,0,0
Public Property Get Valor() As Remito_Estado
    Valor = m_Valor
End Property

Public Property Let Valor(ByVal New_Valor As Remito_Estado)
    m_Valor = New_Valor
    PropertyChanged "Valor"
    If New_Valor = EstadoNulo Then
        cboRemitoEstado.ListIndex = -1
        lblRemitoEstado.Caption = ""
    Else
        cboRemitoEstado.ListIndex = New_Valor
        lblRemitoEstado.Caption = New_Valor
    End If
End Property
