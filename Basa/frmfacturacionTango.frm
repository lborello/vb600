...
Begin VB.Form frmfacturacionTango 
   ClientHeight    =   9870
   ClientLeft      =   -30
   ClientTop       =   840
   ClientWidth     =   13110
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton cmdFacturacionMensual 
            Caption         =   "Planilla General Tango"
            BeginProperty Font 
               Name            =   "Calibri"
               Size            =   9
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmfacturacionTango"
...
Private Function Cod_00017_ABONO_ALMACENAJE_DE_LEGAJOS()
    Dim Sql As String
    Dim rs As New ADODB.Recordset
        ...
        rs.Open Sql, ConActiva, 0, 1
        If Not IsNull(rs!CANTIDAD_LEGAJOS) Then
            If rs!CANTIDAD_LEGAJOS > 0 Then
                Sql = " INSERT INTO FACTURACION_TANGO("
                Sql = Sql & vbCrLf & " ID_PROCESO "
                Sql = Sql & vbCrLf & ", TITULO "
                Sql = Sql & vbCrLf & ", COD_CLIENTE"
                Sql = Sql & vbCrLf & ", STA11_COD_ARTICU"
                Sql = Sql & vbCrLf & ", STA11_DESCRIPCIO"
                ...
                Sql = Sql & vbCrLf & "," & COD_CLIENTE
                Sql = Sql & vbCrLf & ",'00017'"
                Sql = Sql & vbCrLf & ", 'ABONO ALMACENAJE DE LEGAJOS'"
                Sql = Sql & vbCrLf & "," & rs!CANTIDAD_LEGAJOS
                Sql = Sql & vbCrLf & ",1"
                Sql = Sql & ")"
                ExecutarSql Sql
            End If
...
Private Sub Cod_00055_ALTA_DE_LEGAJOS_EN_EL_SISTEMA()
    Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim LEGAJOS_CRECIMIENTO_MES As Integer
        
        Sql = " SELECT  COUNT(*) AS CANTIDADLEGAJOS, NRO_CAJA"
        Sql = Sql & " From LEGAJOS"
    ...
    Do While Not rs.EOF
        ...
        Sql = "Insert Into FACTURACION_DETALLE_TANGO("
        Sql = Sql & vbCrLf & "ID_PROCESO"
        Sql = Sql & vbCrLf & ",COD_CLIENTE"
        Sql = Sql & vbCrLf & ",STA11_COD_ARTICU"
        Sql = Sql & vbCrLf & ",NRO_COMPROBANTE"
        Sql = Sql & vbCrLf & ",DETALLE_COMPROBANTE"
        Sql = Sql & vbCrLf & ",CANTIDAD"
        Sql = Sql & vbCrLf & ", APELLIDO_NOMBRE_FIRMA_CLIENTE"
        ...
        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
        Sql = Sql & vbCrLf & "," & COD_CLIENTE
        Sql = Sql & vbCrLf & ",'00055'"
        Sql = Sql & vbCrLf & ",'" & rs!NRO_CAJA & "'"
        Sql = Sql & vbCrLf & ",'Nº Caja '"
        Sql = Sql & vbCrLf & "," & rs!CANTIDADLEGAJOS
        Sql = Sql & vbCrLf & ", 'Carga de Legajos'"
        Sql = Sql & vbCrLf & ",'ALTA DE LEGAJOS EN EL SISTEMA'"
        Sql = Sql & vbCrLf & ",'0'"
        Sql = Sql & vbCrLf & ",1"
        Sql = Sql & vbCrLf & ")"
        ExecutarSql Sql
        LEGAJOS_CRECIMIENTO_MES = LEGAJOS_CRECIMIENTO_MES + rs!CANTIDADLEGAJOS
        rs.MoveNext
    Loop
    
    If LEGAJOS_CRECIMIENTO_MES <> 0 Then
        ...
        Sql = Sql & vbCrLf & ",'00055'"
        Sql = Sql & vbCrLf & ", 'ALTA DE LEGAJOS EN EL SISTEMA'"
        Sql = Sql & vbCrLf & "," & LEGAJOS_CRECIMIENTO_MES
        Sql = Sql & vbCrLf & ",1"
        Sql = Sql & ")"
        ExecutarSql Sql
...
'    COD_ARTICU DESCRIPCIO
'00010   ABONO ALMACENAJE DE CAJAS
'00012   CAJAS ADMINISTRADAS ASP
'00013   ABONO ALMACENAJE DE LIBROS
'00015   ABONO MINIMO MENSUAL DE CAJAS
'00017   ABONO ALMACENAJE DE LEGAJOS
'20      CAJAS ARCHIVADORAS
'00025   RECAMBIO DE CAJAS ARCHIVADORAS
'00030   HORAS DE ARCHIVISTAS EN PLANTA
'00035   HORAS DE ARCHIVISTA EN CLIENTE
'40      CONSULTA CAJAS - LEGAJOS - LIBROS
'00050   ALTA DE CAJA EN EL SISTEMA
'00052   ALTA DE LIBROS EN EL SISTEMA
'00053   REFERENCIACION Y TRASVASE
'00055   ALTA DE LEGAJOS EN EL SISTEMA
'70      IMAG.DIGITALIZADAS P / CONSULTA
'00075   SERVICIO DE DIGITALIZACION
'80      flete Normal - ENVIO / Retiro
'00085   SERVICIO DE FLETE URGENTE
'00087   RETIROS DE CAJAS
'00089   RETIROS O ENVIOS ESPECIALES
'00100   SERVICIO DE BAJA DEFINITIVA
'00120   ETIQUETAS PARA CAJAS
'00125   ETIQUETAS PARA LEGAJOS
'00130   PRECINTOS DE SEGURIDAD
'00150   MANTENIMIENTO DEL SISTEMA
'00155   USO DEL SISTEMA ASP
'01000   POR ANULACION FACTURA
'01001   SERVICIO GUARDA DOC SAN JUAN
End Sub
...
Public Sub Cod_00010_ABONO_ALMACENAJE_DE_CAJAS()
        
        Dim rs As ADODB.Recordset
        Dim CAJAS As Long
        Dim CajasBajas As Long
        Dim Sql As String
        Dim CAJAS_CANTIDAD  As Double
        CAJAS_CANTIDAD = 0
        If COD_CLIENTE = 39 Then
            CAJAS = 16955
        Else
            Sql = " SELECT SUM(CANTIDAD) As cantidadCajas "
            Sql = Sql & vbCrLf & " From REMITOS_CUERPO "
            ...
            Else
                ...
                End If
            End If
            CAJAS = CAJAS + CajasSumaResta(COD_CLIENTE)
        End If
    ...
    Sql = Sql & vbCrLf & ",'" & TITULO_SQL & "'"
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00010'"
    Sql = Sql & vbCrLf & ", 'ABONO ALMACENAJE DE CAJAS'"
    Sql = Sql & vbCrLf & "," & CAJAS_CANTIDAD
    Sql = Sql & vbCrLf & ",1"
    Sql = Sql & ")"
...
Public Function Cod_00050_ALTA_DE_CAJA_EN_EL_SISTEMA() As Integer
    
    
    
    Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim CAJAS_CRECIMIENTO_MES As Integer
    
    
    
    CAJAS_CRECIMIENTO_MES = 0
    
    Sql = "  SELECT  REMITOS_CUERPO.NRO_REMITO, REMITOS_CUERPO.NRO_REM_PROV, REMITOS_CUERPO.FECHA, REMITOS_CUERPO.CANTIDAD, REMITOS_CUERPO.IMAGEN, CLIENTEUSUARIO.APELLIDO_NOMBRE"
    ...
    Do While Not rs.EOF
        ...
        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
        Sql = Sql & vbCrLf & "," & COD_CLIENTE
        Sql = Sql & vbCrLf & ",'00050'"
        Sql = Sql & vbCrLf & ",'" & Trim(rs!NRO_REM_PROV) & "'"
        Sql = Sql & vbCrLf & ",'Remito'"
        Sql = Sql & vbCrLf & "," & rs!Cantidad
        Sql = Sql & vbCrLf & ", '" & Trim(rs!APELLIDO_NOMBRE) & "'"
        Sql = Sql & vbCrLf & ",'Ingreso de Cajas '"
        If IsNull(rs!Imagen) Then
            Sql = Sql & vbCrLf & ",'0'"
        Else
            Sql = Sql & vbCrLf & ",'\\222.15.19.251\basa\Administracion\Imagenes_Internas\Remitos\" & Trim(rs!NRO_REM_PROV) & "\" & rs!Imagen & "'"
        End If
        Sql = Sql & vbCrLf & ",'" & rs!fecha & "'"
        Sql = Sql & vbCrLf & ",1"
        Sql = Sql & vbCrLf & ")"
        ExecutarSql Sql


        CAJAS_CRECIMIENTO_MES = CAJAS_CRECIMIENTO_MES + rs!Cantidad
       
        rs.MoveNext
    Loop
    
    If CAJAS_CRECIMIENTO_MES <> 0 Then
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00050'"
    Sql = Sql & vbCrLf & ", 'ALTA DE CAJA EN EL SISTEMA'"
    Sql = Sql & vbCrLf & "," & CAJAS_CRECIMIENTO_MES
     Sql = Sql & vbCrLf & ",1"
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Sub Cod_00020_CAJAS_ARCHIVADORAS()
    ...
    Do While Not rs.EOF
        ...
        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
        Sql = Sql & vbCrLf & "," & COD_CLIENTE
        Sql = Sql & vbCrLf & ",'00020'"
        Sql = Sql & vbCrLf & ",'" & Trim(rs!NRO_REMITO) & "'"
        Sql = Sql & vbCrLf & ",'REMITO'"
        Sql = Sql & vbCrLf & "," & rs!Cantidad
        Sql = Sql & vbCrLf & ", '" & Trim(rs!APELLIDO_NOMBRE) & "'"
        Sql = Sql & vbCrLf & ",'CAJAS ARCHIVADORAS'"
        If IsNull(rs!Imagen) Then
            Sql = Sql & vbCrLf & ",'0'"
        Else
            Sql = Sql & vbCrLf & ",'\\222.15.19.251\basa\Administracion\Imagenes_Internas\Remitos\" & Trim(rs!NRO_REMITO) & "\" & rs!Imagen & "'"
        End If
        Sql = Sql & vbCrLf & ",'" & rs!fecha & "'"
        Sql = Sql & vbCrLf & ",1"
        Sql = Sql & vbCrLf & ")"
...
Public Sub Cod_00080_SERVICIO_DE_FLETE_NORMAL()
    
    Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim Cantidad_Fletes As Integer
    Dim Total_Cantidad_Fletes As Integer
    Dim Cod_Flete As Long
    Dim Fecha_Control As String
    Dim Usuario_Control As String
    ...
    Usuario_Control = ""
            ...
            Cantidad_Fletes = 0
            Sql = " SELECT REMITO_ESTADOS.DESCRIPCION, REMITOS_CUERPO.NRO_REMITO, REMITOS_CUERPO.ESTADO, REMITOS_CUERPO.ID_CLIENTE, CONVERT(char, REMITOS_CUERPO.FECHA, 103) AS FECHA , REMITOS_CUERPO.ANULADO,"
            Sql = Sql & vbCrLf & " CLIENTEUSUARIO.APELLIDO_NOMBRE , REMITOS_CUERPO.NRO_REM_PROV, REMITOS_CUERPO.Cod_Flete, REMITOS_CUERPO.COBRAR_FLETE,  REMITO_OPERACION.DESCRIPCION AS ENTRADA_SALIDA , REMITOS_CUERPO.Imagen "
            Sql = Sql & vbCrLf & " FROM REMITOS_CUERPO LEFT OUTER JOIN"
            ...
            Sql = Sql & vbCrLf & " CLIENTEUSUARIO ON REMITOS_CUERPO.COD_USUARIO_CLIENTE = CLIENTEUSUARIO.ID_CLIENTEUSUARIO"
            Sql = Sql & vbCrLf & " WHERE REMITOS_CUERPO.ID_CLIENTE = " & COD_CLIENTE
            Sql = Sql & vbCrLf & " AND (REMITOS_CUERPO.ANULADO IS NULL) "
            Sql = Sql & vbCrLf & " AND (REMITOS_CUERPO.ESTADO = 0)"
            Sql = Sql & vbCrLf & " AND FECHA BETWEEN " & FechaFormato(FECHA_INICIO)
            Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
            Sql = Sql & vbCrLf & " ORDER BY REMITOS_CUERPO.FECHA, REMITOS_CUERPO.NRO_REMITO"
            Set rs = New ADODB.Recordset
            rs.Open Sql, ConActiva, 0, 1
            Cantidad_Fletes = 0
            Do While Not rs.EOF
            
            If Fecha_Control = Trim(rs!fecha) Then
                If Usuario_Control = Trim(rs!APELLIDO_NOMBRE) Then
                    Cantidad_Fletes = 0
                Else
                    Cantidad_Fletes = 1
                    Usuario_Control = Trim(rs!APELLIDO_NOMBRE)
                End If
            Else
                Fecha_Control = Trim(rs!fecha)
                Usuario_Control = Trim(rs!APELLIDO_NOMBRE)
                Cantidad_Fletes = 1
            End If
        ...
        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
        Sql = Sql & vbCrLf & "," & COD_CLIENTE
        Sql = Sql & vbCrLf & ",'00080'"
        If Trim(rs!NRO_REM_PROV) = "0001-000_____" Then
            Sql = Sql & vbCrLf & ",'" & Trim(rs!NRO_REMITO) & "'"
            REMITO = Trim(rs!NRO_REMITO)
         Else
            Sql = Sql & vbCrLf & ",'" & Trim(rs!NRO_REM_PROV) & "'"
            REMITO = Trim(rs!NRO_REM_PROV)
        End If
        Sql = Sql & vbCrLf & ",'Remito'"
        Sql = Sql & vbCrLf & "," & Cantidad_Fletes
        Sql = Sql & vbCrLf & ", '" & Trim(rs!APELLIDO_NOMBRE) & "'"
        Sql = Sql & vbCrLf & ",'" & LCase(Trim(rs!ENTRADA_SALIDA)) & "'"
        If IsNull(rs!Imagen) Then
            Sql = Sql & vbCrLf & ",'0'"
        Else
            Sql = Sql & vbCrLf & ",'\\222.15.19.251\basa\Administracion\Imagenes_Internas\Remitos\" & Trim(REMITO) & "\" & rs!Imagen & "'"
        End If
        Sql = Sql & vbCrLf & ",'" & rs!fecha & "'"
        Sql = Sql & vbCrLf & ",1"
        Sql = Sql & vbCrLf & ")"
        ...
        Total_Cantidad_Fletes = Total_Cantidad_Fletes + Cantidad_Fletes
       
        rs.MoveNext
    Loop
    
    If Total_Cantidad_Fletes <> 0 Then
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00080'"
    Sql = Sql & vbCrLf & ", 'SERVICIO DE FLETE NORMAL'"
    Sql = Sql & vbCrLf & "," & Total_Cantidad_Fletes
    Sql = Sql & vbCrLf & ",1"
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Sub Cod_00085_SERVICIO_DE_FLETE_URGENTE()
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00085'"
    Sql = Sql & vbCrLf & ", 'SERVICIO DE FLETE URGENTES'"
    Sql = Sql & vbCrLf & "," & Total_Cantidad_Fletes
    Sql = Sql & vbCrLf & ",1"
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Sub Cod_00013_ABONO_ALMACENAJE_DE_LIBROS()
        Dim Sql As String
        Dim rs As New ADODB.Recordset
        Dim LibrosAlta As Integer
        Dim LibrosBajas As Integer
        Dim LibrosCantidad As Integer
        ...
        End If
            ...
            LibrosCantidad = CLng(LibrosAlta) - CLng(LibrosBajas)
            
            If LibrosCantidad > 0 Then
                Sql = " INSERT INTO FACTURACION_TANGO("
                Sql = Sql & vbCrLf & " ID_PROCESO "
                Sql = Sql & vbCrLf & ", TITULO "
                Sql = Sql & vbCrLf & ", COD_CLIENTE"
                ...
                Sql = Sql & vbCrLf & ",'" & TITULO_SQL & "'"
                Sql = Sql & vbCrLf & "," & COD_CLIENTE
                Sql = Sql & vbCrLf & ",'00013'"
                Sql = Sql & vbCrLf & ", 'ABONO ALMACENAJE DE LIBRO'"
                Sql = Sql & vbCrLf & "," & LibrosCantidad
                Sql = Sql & vbCrLf & ",1"
                Sql = Sql & ")"
                ExecutarSql Sql
             End If
...
Public Sub Cod_00025_RECAMBIO_DE_CAJAS_ARCHIVADORAS()
    Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim CAJAS_RECAMBIO As Integer
        CAJAS_RECAMBIO = 0
        Sql = " SELECT  ID, FK_CLIENTE, NRO_CAJA, FECHA"
        Sql = Sql & vbCrLf & " From RECAMBIO_CAJA "
        ...
        Do While Not rs.EOF
            ...
            Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
            Sql = Sql & vbCrLf & "," & COD_CLIENTE
            Sql = Sql & vbCrLf & ",'00025'"
            Sql = Sql & vbCrLf & ",'" & Trim(rs!NRO_CAJA) & "'"
            Sql = Sql & vbCrLf & ",'NRO de CAJA'"
            Sql = Sql & vbCrLf & ",1"
            Sql = Sql & vbCrLf & ", 'EN PLANTA'"
            Sql = Sql & vbCrLf & ",'RECAMBIO DE CAJAS ARCHIVADORAS'"
            Sql = Sql & vbCrLf & ",'0'"
            Sql = Sql & vbCrLf & ",'" & rs!fecha & "'"
            Sql = Sql & vbCrLf & ",1"
            Sql = Sql & vbCrLf & ")"
            ExecutarSql Sql
            CAJAS_RECAMBIO = CAJAS_RECAMBIO + 1
            rs.MoveNext
        Loop
        If CAJAS_RECAMBIO <> 0 Then
            Sql = " INSERT INTO FACTURACION_TANGO("
            Sql = Sql & vbCrLf & " ID_PROCESO "
            Sql = Sql & vbCrLf & ", TITULO "
            Sql = Sql & vbCrLf & ", COD_CLIENTE"
            ...
            Sql = Sql & vbCrLf & "," & COD_CLIENTE
            Sql = Sql & vbCrLf & ",'00025'"
            Sql = Sql & vbCrLf & ", 'RECAMBIO_DE_CAJAS_ARCHIVADORAS'"
            Sql = Sql & vbCrLf & "," & CAJAS_RECAMBIO
            Sql = Sql & vbCrLf & ",1"
            Sql = Sql & ")"
            ExecutarSql Sql
        End If
...
Public Sub Cod_00100_SERVICIO_DE_BAJA_DEFINITIVA()

 Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim CAJAS_MES As Integer
    ...
    Do While Not rs.EOF
        ...
        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
        Sql = Sql & vbCrLf & "," & COD_CLIENTE
        Sql = Sql & vbCrLf & ",'00100'"
        Sql = Sql & vbCrLf & ",'" & Trim(rs!NRO_REM_PROV) & "'"
        Sql = Sql & vbCrLf & ",'REMITO'"
        Sql = Sql & vbCrLf & "," & rs!Cantidad
        Sql = Sql & vbCrLf & ", '" & Trim(rs!APELLIDO_NOMBRE) & "'"
        Sql = Sql & vbCrLf & ",'BAJA DE CAJAS'"
        If IsNull(rs!Imagen) Then
            Sql = Sql & vbCrLf & ",'0'"
        Else
            Sql = Sql & vbCrLf & ",'\\222.15.19.251\basa\Administracion\Imagenes_Internas\Remitos\" & Trim(rs!NRO_REM_PROV) & "\" & rs!Imagen & "'"
        ...
        CAJAS_MES = CAJAS_MES + rs!Cantidad
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00100'"
    Sql = Sql & vbCrLf & ", 'SERVICIO DE BAJA DEFINITIVA'"
    Sql = Sql & vbCrLf & "," & CAJAS_MES
    Sql = Sql & vbCrLf & ",1"
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Sub Cod_00040_CONSULTA_CAJAS_LEGAJOS_LIBROS()
    Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim Consultas_Mes As Integer
    ...
    ' Consutas de remitos
    Sql = " SELECT  REMITOS_CUERPO.NRO_REMITO, REMITOS_CUERPO.NRO_REM_PROV, TIPO_ALMACENAMIENTO.DESCRIPCION as TIPO_ELEMENTO, REMITOS_CUERPO.FECHA, REMITOS_CUERPO.CANTIDAD, REMITOS_CUERPO.IMAGEN,"
    Sql = Sql & vbCrLf & " CLIENTEUSUARIO.APELLIDO_NOMBRE"
    Sql = Sql & vbCrLf & " FROM REMITOS_CUERPO LEFT OUTER JOIN"
    ...
    Sql = Sql & vbCrLf & " AND FECHA BETWEEN " & FechaFormato(FECHA_INICIO)
    Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
    Sql = Sql & vbCrLf & " ORDER BY NRO_REMITO , TIPO_ALMACENAMIENTO.DESCRIPCION  "
    ...
    Do While Not rs.EOF
       ...
       Sql = Sql & vbCrLf & ",GRUPO"
        ...
        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
        Sql = Sql & vbCrLf & "," & COD_CLIENTE
        Sql = Sql & vbCrLf & ",'00040'"
        Sql = Sql & vbCrLf & ",'" & Trim(rs!NRO_REMITO) & "'"
        Sql = Sql & vbCrLf & ",'Remito '"
        Sql = Sql & vbCrLf & "," & rs!Cantidad
        Sql = Sql & vbCrLf & ", '" & Trim(rs!APELLIDO_NOMBRE) & "'"
        Sql = Sql & vbCrLf & ",'Consulta de  " & LCase(Trim(rs!TIPO_ELEMENTO)) & "'"
        If IsNull(rs!Imagen) Then
            Sql = Sql & vbCrLf & ",'0'"
        Else
            Sql = Sql & vbCrLf & ",'\\222.15.19.251\basa\Administracion\Imagenes_Internas\Remitos\" & Trim(rs!NRO_REM_PROV) & "\" & rs!Imagen & "'"
        ...
        Sql = Sql & vbCrLf & ")"
        ExecutarSql Sql
        Consultas_Mes = Consultas_Mes + rs!Cantidad
        rs.MoveNext
    Loop
                ...
                Sql = Sql & vbCrLf & " FROM  REQUERIMIENTO LEFT OUTER JOIN"
                Sql = Sql & vbCrLf & " TIPOREQUERIMIENTO ON REQUERIMIENTO.IDTIPOREQUERIMIENTO = TIPOREQUERIMIENTO.IDTIPOREQUERIMIENTO"
                Sql = Sql & vbCrLf & " WHERE ID_CLIENTE =  " & COD_CLIENTE
                Sql = Sql & vbCrLf & " AND REQUERIMIENTO.IDTIPOREQUERIMIENTO in (13,14,9) "
                Sql = Sql & vbCrLf & " AND (ANULADO IS NULL)"
                Sql = Sql & vbCrLf & " AND  FECHARECEPCION Between " & FechaFormato(FECHA_INICIO)
                Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
                Sql = Sql & vbCrLf & " ORDER BY TIPOREQUERIMIENTO.DESCRIPCION, REQUERIMIENTO.IDREQUERIMIENTO"
                Set rs = New ADODB.Recordset
                rs.Open Sql, ConActiva, 0, 1
                ...
                Do While Not rs.EOF
                        ...
                        Sql = Sql & vbCrLf & "," & COD_CLIENTE
                        Sql = Sql & vbCrLf & ",'00040'"
                        Sql = Sql & vbCrLf & ",'" & Trim(rs!IDREQUERIMIENTO) & "'"
                        Sql = Sql & vbCrLf & ",'REQUERIMIENTO'"
                        Sql = Sql & vbCrLf & "," & rs!Cantidad
                        Sql = Sql & vbCrLf & ", '" & Trim(rs!TIPO_REQUERIMIENTO_DESCRIPCION) & "'"
                        Sql = Sql & vbCrLf & ",'" & Trim(rs!TIPO_REQUERIMIENTO_DESCRIPCION) & "'"
                        Sql = Sql & vbCrLf & ",'0'"
                        Sql = Sql & vbCrLf & ",1"
                        Sql = Sql & vbCrLf & ")"
    ...
    If Consultas_Mes <> 0 Then
        ...
        Sql = Sql & vbCrLf & "," & COD_CLIENTE
        Sql = Sql & vbCrLf & ",'00040'"
        Sql = Sql & vbCrLf & ", 'CONSULTA DE CAJAS/LEGAJOS/LIBROS'"
        Sql = Sql & vbCrLf & "," & Consultas_Mes
        Sql = Sql & vbCrLf & ",1"
        Sql = Sql & ")"
        ExecutarSql Sql
    End If
...
Public Sub Cod_00070_IMAG_DIGITALIZADAS_PARA_CONSULTA_DIGITAL()

 Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim Imagenes_Requerimiento As Integer
    
    
    
    Imagenes_Requerimiento = 0
                ...
                Sql = " SELECT REQUERIMIENTO.IDREQUERIMIENTO, TIPOREQUERIMIENTO.DESCRIPCION as  TIPO_REQUERIMIENTO_DESCRIPCION , REQUERIMIENTO.FECHARECEPCION, REQUERIMIENTO.CANTIDAD_IMAGENES"
                Sql = Sql & vbCrLf & " FROM  REQUERIMIENTO LEFT OUTER JOIN"
                Sql = Sql & vbCrLf & " TIPOREQUERIMIENTO ON REQUERIMIENTO.IDTIPOREQUERIMIENTO = TIPOREQUERIMIENTO.IDTIPOREQUERIMIENTO"
                Sql = Sql & vbCrLf & " WHERE ID_CLIENTE =  " & COD_CLIENTE
                Sql = Sql & vbCrLf & " AND REQUERIMIENTO.IDTIPOREQUERIMIENTO in (13) "
                Sql = Sql & vbCrLf & " AND (ANULADO IS NULL)"
                Sql = Sql & vbCrLf & " AND  FECHARECEPCION Between " & FechaFormato(FECHA_INICIO)
                Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
                Sql = Sql & vbCrLf & " ORDER BY TIPOREQUERIMIENTO.DESCRIPCION, REQUERIMIENTO.IDREQUERIMIENTO"
                ...
                Do While Not rs.EOF
                        ...
                        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
                        Sql = Sql & vbCrLf & "," & COD_CLIENTE
                        Sql = Sql & vbCrLf & ",'00070'"
                        Sql = Sql & vbCrLf & ",'" & Trim(rs!IDREQUERIMIENTO) & "'"
                        Sql = Sql & vbCrLf & ",'REQUERIMIENTO'"
                        If Not IsNull(rs!Cantidad_Imagenes) Then
                        Sql = Sql & vbCrLf & "," & rs!Cantidad_Imagenes
                        Else
                            Sql = Sql & vbCrLf & ",999"
                            MsgBox "Faltan las imagenes del requerimiento:" & rs!IDREQUERIMIENTO
                        End If
                        Sql = Sql & vbCrLf & ", '" & Trim(rs!TIPO_REQUERIMIENTO_DESCRIPCION) & "'"
                        Sql = Sql & vbCrLf & ",'" & Trim(rs!TIPO_REQUERIMIENTO_DESCRIPCION) & "'"
                        Sql = Sql & vbCrLf & ",'0'"
                        Sql = Sql & vbCrLf & ",'" & rs!FECHARECEPCION & "'"
                        Sql = Sql & vbCrLf & ",1"
                        Sql = Sql & vbCrLf & ")"
                        ExecutarSql Sql
                        If IsNull(rs!Cantidad_Imagenes) Then
                         MsgBox "Faltan las imágenes requerimiento se asignarán 99"
                            Imagenes_Requerimiento = Imagenes_Requerimiento + 99
                       Else
                            Imagenes_Requerimiento = Imagenes_Requerimiento + rs!Cantidad_Imagenes
                        End If
    ...
    If Imagenes_Requerimiento <> 0 Then
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00070'"
    Sql = Sql & vbCrLf & ", 'DIGITALIZADAS PARA CONSULTA DIGITAL'"
    Sql = Sql & vbCrLf & "," & Imagenes_Requerimiento
    Sql = Sql & ",1"
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Sub Cod_00075_SERVICIO_DE_DIGITALIZACION()

 Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim rsCajasFacturar As ADODB.Recordset
    Dim CajaAnterior As Double
    Dim Cantidad_Imagenes_Caja As Double
    Dim Cantidad_Imagenes_Totales As Double
    Dim RemitoAnterior As String
    ...
    Cantidad_Imagenes_Caja = 0
    Cantidad_Imagenes_Totales = 0
    ...
    CajaAnterior = 0
                ...
                Sql = Sql & vbCrLf & "  WHERE  (LOTE_ESTADO = N'PARA FACTURAR')"
                Sql = Sql & vbCrLf & "  GROUP BY FK_CLIENTES, FK_CAJAS , FK_INDICES"
                Sql = Sql & vbCrLf & "  Having FK_CLIENTES = " & COD_CLIENTE
                Sql = Sql & vbCrLf & " ORDER BY FK_INDICES"
               If COD_CLIENTE = 229 Then
                MsgBox "229"
               End If
               
                
                Set rsCajasFacturar = New ADODB.Recordset
                rsCajasFacturar.Open Sql, strConBasa
                
                
                
                If rsCajasFacturar.EOF Then
                 Exit Sub
                End If
                ...
                Do While Not rsCajasFacturar.EOF
                    Sql = "  SELECT  DOCUMENTOS_DIGITALES_LOTE.FK_CAJAS, DOCUMENTOS_DIGITALES_LOTE.ID_DOCUMENTOS_DIGITALES_LOTE, DOCUMENTOS_DIGITALES_LOTE.FK_CLIENTES, DOCUMENTOS_DIGITALES_LOTE.LOTE_ESTADO, CONVERT (char (10), DOCUMENTOS_DIGITALES_LOTE.FECHA_INGRESO ,103) as FECHA_INGRESO ,"
                    Sql = Sql & vbCrLf & " DOCUMENTOS_DIGITALES_LOTE.REMITO, INDICES.DESCRIPCION,  sum( DOCUMENTOS_DIGITALES.CANTIDAD_IMAGENES) as Cantidad_Imagenes"
                    Sql = Sql & vbCrLf & " FROM DOCUMENTOS_DIGITALES_LOTE INNER JOIN"
                    Sql = Sql & vbCrLf & " DOCUMENTOS_DIGITALES ON DOCUMENTOS_DIGITALES_LOTE.ID_DOCUMENTOS_DIGITALES_LOTE = DOCUMENTOS_DIGITALES.FK_DOCUMENTOS_DIGITALES_LOTE LEFT OUTER JOIN"
                    Sql = Sql & vbCrLf & " INDICES ON DOCUMENTOS_DIGITALES_LOTE.FK_INDICES = INDICES.ID"
                    Sql = Sql & vbCrLf & " WHERE (DOCUMENTOS_DIGITALES.ESTADO LIKE N'%EXPORTADA%')"
                    Sql = Sql & vbCrLf & " GROUP BY DOCUMENTOS_DIGITALES_LOTE.FK_CAJAS, DOCUMENTOS_DIGITALES_LOTE.ID_DOCUMENTOS_DIGITALES_LOTE, DOCUMENTOS_DIGITALES_LOTE.FK_CLIENTES, DOCUMENTOS_DIGITALES_LOTE.LOTE_ESTADO,CONVERT (char (10), DOCUMENTOS_DIGITALES_LOTE.FECHA_INGRESO ,103) ,"
                    Sql = Sql & vbCrLf & " DOCUMENTOS_DIGITALES_LOTE.Remito , INDICES.Descripcion"
                    Sql = Sql & vbCrLf & " HAVING (DOCUMENTOS_DIGITALES_LOTE.LOTE_ESTADO LIKE N'PARA FACTURAR') "
                    Sql = Sql & vbCrLf & " AND DOCUMENTOS_DIGITALES_LOTE.FK_CLIENTES = " & rsCajasFacturar!FK_CLIENTES
                    Sql = Sql & vbCrLf & " AND DOCUMENTOS_DIGITALES_LOTE.FK_CAJAS = " & rsCajasFacturar!FK_CAJAS
                    Sql = Sql & vbCrLf & " ORDER BY  DOCUMENTOS_DIGITALES_LOTE.ID_DOCUMENTOS_DIGITALES_LOTE"
                        Set rs = New ADODB.Recordset
                        rs.Open Sql, ConActiva, 0, 1
                        Do While Not rs.EOF
                            Lotes = Lotes & " - " + Trim(rs!ID_DOCUMENTOS_DIGITALES_LOTE)
                            Cantidad_Imagenes_Caja = Cantidad_Imagenes_Caja + rs!Cantidad_Imagenes
                            RemitoAnterior = rs!REMITO
                            DetalleAnterior = Trim(rs!Descripcion)
                        ...
                        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
                        Sql = Sql & vbCrLf & "," & COD_CLIENTE
                        Sql = Sql & vbCrLf & ",'00075'"
                        Sql = Sql & vbCrLf & ",'" & RemitoAnterior & "'"
                        Sql = Sql & vbCrLf & ",'Remito'"
                        Sql = Sql & vbCrLf & "," & Cantidad_Imagenes_Caja
                        Sql = Sql & vbCrLf & ",'" & Lotes & "'"
                        Sql = Sql & vbCrLf & ",'" & rsCajasFacturar!FK_CAJAS & "'"
                        Sql = Sql & vbCrLf & ",'" & LCase(Trim(DetalleAnterior)) & "'"
                        Sql = Sql & vbCrLf & ",'" & fecha & "'"
                        Sql = Sql & vbCrLf & ",1"
                        Sql = Sql & vbCrLf & ")"
                        ExecutarSql Sql
                        Cantidad_Imagenes_Totales = Cantidad_Imagenes_Totales + Cantidad_Imagenes_Caja
                        Cantidad_Imagenes_Caja = 0
                        Lotes = ""
                        rsCajasFacturar.MoveNext
               Loop
               
               If Cantidad_Imagenes_Totales <> 0 Then
                    Sql = " INSERT INTO FACTURACION_TANGO("
                    Sql = Sql & vbCrLf & " ID_PROCESO "
                    Sql = Sql & vbCrLf & ", TITULO "
                    Sql = Sql & vbCrLf & ", COD_CLIENTE"
                    ...
                    Sql = Sql & vbCrLf & "," & COD_CLIENTE
                    Sql = Sql & vbCrLf & ",'00075'"
                    Sql = Sql & vbCrLf & ", 'SERVICIO DE DIGITALIZACION'"
                    Sql = Sql & vbCrLf & "," & Cantidad_Imagenes_Totales
                    Sql = Sql & vbCrLf & ",1"
                    Sql = Sql & ")"
                    ExecutarSql Sql
    End If
...
Public Sub Cod_00087_RETIROS_DE_CAJAS()

 Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim Cantidad_Retiro As Integer
    ...
    Cantidad_Retiro = 0
                ...
                Sql = Sql & vbCrLf & " TIPOREQUERIMIENTO ON REQUERIMIENTO.IDTIPOREQUERIMIENTO = TIPOREQUERIMIENTO.IDTIPOREQUERIMIENTO"
                Sql = Sql & vbCrLf & " WHERE ID_CLIENTE =  " & COD_CLIENTE
                Sql = Sql & vbCrLf & " AND REQUERIMIENTO.IDTIPOREQUERIMIENTO in (6) "
                Sql = Sql & vbCrLf & " AND (ANULADO IS NULL)"
                Sql = Sql & vbCrLf & " AND  FECHARECEPCION Between " & FechaFormato(FECHA_INICIO)
                Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
                Sql = Sql & vbCrLf & " ORDER BY TIPOREQUERIMIENTO.DESCRIPCION, REQUERIMIENTO.IDREQUERIMIENTO"
                ...
                Do While Not rs.EOF
                        ...
                        Sql = Sql & vbCrLf & ")"
                        ExecutarSql Sql
                        Cantidad_Retiro = Cantidad_Retiro + rs!Cantidad
                        rs.MoveNext
                   
               Loop
 
    
    If Cantidad_Retiro <> 0 Then
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00087'"
    Sql = Sql & vbCrLf & ", 'RETIRO DE CAJAS'"
    Sql = Sql & vbCrLf & "," & Cantidad_Retiro
    Sql = Sql & vbCrLf & ",1"
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Sub Cod_00089_RETIROS_O_ENVIOS_ESPECIALES()
 ...
 Dim Sql As String
    ...
    Cantidad_Retiro = 0
                ...
                Sql = Sql & vbCrLf & " TIPOREQUERIMIENTO ON REQUERIMIENTO.IDTIPOREQUERIMIENTO = TIPOREQUERIMIENTO.IDTIPOREQUERIMIENTO"
                Sql = Sql & vbCrLf & " WHERE ID_CLIENTE =  " & COD_CLIENTE
                Sql = Sql & vbCrLf & " AND REQUERIMIENTO.IDTIPOREQUERIMIENTO in (20) "
                Sql = Sql & vbCrLf & " AND (ANULADO IS NULL)"
                Sql = Sql & vbCrLf & " AND  FECHARECEPCION Between " & FechaFormato(FECHA_INICIO)
                Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
                Sql = Sql & vbCrLf & " ORDER BY TIPOREQUERIMIENTO.DESCRIPCION, REQUERIMIENTO.IDREQUERIMIENTO"
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00089"
    Sql = Sql & vbCrLf & ", 'RETIRO O ENVIO ESPECIALES'"
    Sql = Sql & vbCrLf & "," & Cantidad_Retiro
    Sql = Sql & ")"
    ExecutarSql Sql
...
End Sub
Public Sub Cod_00120_ETIQUETAS_PARA_CAJAS()
    ...
    Cantidad_Etiquetas = 0
                ...
                Sql = Sql & vbCrLf & " TIPOREQUERIMIENTO ON REQUERIMIENTO.IDTIPOREQUERIMIENTO = TIPOREQUERIMIENTO.IDTIPOREQUERIMIENTO"
                Sql = Sql & vbCrLf & " WHERE ID_CLIENTE =  " & COD_CLIENTE
                Sql = Sql & vbCrLf & " AND REQUERIMIENTO.IDTIPOREQUERIMIENTO in (26) "
                Sql = Sql & vbCrLf & " AND (ANULADO IS NULL)"
                Sql = Sql & vbCrLf & " AND  FECHARECEPCION Between " & FechaFormato(FECHA_INICIO)
                Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
                Sql = Sql & vbCrLf & " ORDER BY TIPOREQUERIMIENTO.DESCRIPCION, REQUERIMIENTO.IDREQUERIMIENTO"
                ...
                Do While Not rs.EOF
                        ...
                        Sql = Sql & vbCrLf & ")"
                        ExecutarSql Sql
                        Cantidad_Etiquetas = Cantidad_Etiquetas + rs!Cantidad
                        rs.MoveNext
    ...
    Sql = Sql & vbCrLf & ",'" & TITULO_SQL & "'"
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00120"
    Sql = Sql & vbCrLf & ", 'ETIQUETAS PARA CAJAS'"
    Sql = Sql & vbCrLf & "," & Cantidad_Etiquetas
    Sql = Sql & vbCrLf & ", 1"
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Function Cod_00130_PRECINTOS_DE_SEGURIDAD()
        Dim rs As New ADODB.Recordset
        Dim Sql As String
        Dim IntPrecintos As Integer
            ...
            IntPrecintos = 0
                ...
                Sql = Sql & vbCrLf & " TIPOREQUERIMIENTO ON REQUERIMIENTO.IDTIPOREQUERIMIENTO = TIPOREQUERIMIENTO.IDTIPOREQUERIMIENTO"
                Sql = Sql & vbCrLf & " WHERE ID_CLIENTE =  " & COD_CLIENTE
                Sql = Sql & vbCrLf & " AND REQUERIMIENTO.IDTIPOREQUERIMIENTO in (23) "
                Sql = Sql & vbCrLf & " AND (ANULADO IS NULL)"
                Sql = Sql & vbCrLf & " AND  FECHARECEPCION Between " & FechaFormato(FECHA_INICIO)
                Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
                Sql = Sql & vbCrLf & " ORDER BY TIPOREQUERIMIENTO.DESCRIPCION, REQUERIMIENTO.IDREQUERIMIENTO"
                ...
                Do While Not rs.EOF
                        ...
                        Sql = Sql & vbCrLf & ")"
                        ExecutarSql Sql
                        IntPrecintos = IntPrecintos + rs!Cantidad
                        rs.MoveNext
                   
               Loop
 
    
    If IntPrecintos <> 0 Then
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00130'"
    Sql = Sql & vbCrLf & ", 'PRECINTOS DE SEGURIDAD'"
    Sql = Sql & vbCrLf & "," & IntPrecintos
    Sql = Sql & vbCrLf & ", 1 "
    Sql = Sql & ")"
    ExecutarSql Sql
...
Public Sub Facturacion_Mensual()
    ...
    COD_CLIENTE = 0
    ID_Proceso = Format(Now, "yyMMDD_hh:mm:ss")
    CantidadImagen = 0
...
'       If Control_Requerimientos_Digitales = False Then
'            MsgBox "Proceso interrumpido ", vbCritical
'            Exit Sub
'       End If
        ...
        ' Proceso Inifio de Detalles de Facturacion
        
        TITULO_SQL = "Movimientos del " & FECHA_INICIO & " hasta " & FECHA_FIN
        
        Set rsFacturacion = New ADODB.Recordset
        ExecutarSql " Delete From FACTURACION_DETALLE_TANGO"
       ExecutarSql " Delete From FACTURACION_TANGO"
       BaseTangoClientes
      
       

        Sql = " SELECT ID_CLIENTE, CLIENTE_BASE_TANGO"
        Sql = Sql & vbCrLf & " From Clientes "
        Sql = Sql & vbCrLf & " Where (Not (CLIENTE_BASE_TANGO Is Null))"
        Sql = Sql & vbCrLf & " ORDER BY CLIENTE_BASE_TANGO"
        
        
'        Sql = " SELECT ID_CLIENTE, CLIENTE_BASE_TANGO"
'        Sql = Sql & vbCrLf & " From Clientes "
'       Rem  Sql = Sql & vbCrLf & " Where  ID_CLIENTE in (  1,86,155,229,279,401,403,1123)"
'        Sql = Sql & vbCrLf & " Where  ID_CLIENTE in ( 229)"
'        Sql = Sql & vbCrLf & " ORDER BY CLIENTE_BASE_TANGO"
        
        
        
        rsFacturacion.Open Sql, strConBasa
        
        
        
        
        Do While Not rsFacturacion.EOF
            COD_CLIENTE = rsFacturacion!id_cliente
            Cod_00010_ABONO_ALMACENAJE_DE_CAJAS
            Cod_00020_CAJAS_ARCHIVADORAS
            Cod_00025_RECAMBIO_DE_CAJAS_ARCHIVADORAS
            Cod_00030_HORAS_DE_ARCHIVISTAS_EN_PLANTA
            Cod_00013_ABONO_ALMACENAJE_DE_LIBROS
            Cod_00017_ABONO_ALMACENAJE_DE_LEGAJOS
            Cod_00050_ALTA_DE_CAJA_EN_EL_SISTEMA
            Cod_00055_ALTA_DE_LEGAJOS_EN_EL_SISTEMA
            Cod_00040_CONSULTA_CAJAS_LEGAJOS_LIBROS
            Cod_00070_IMAG_DIGITALIZADAS_PARA_CONSULTA_DIGITAL
            Cod_00075_SERVICIO_DE_DIGITALIZACION
            Cod_00080_SERVICIO_DE_FLETE_NORMAL
            Cod_00085_SERVICIO_DE_FLETE_URGENTE
            Cod_00087_RETIROS_DE_CAJAS
            Cod_00089_RETIROS_O_ENVIOS_ESPECIALES
            Cod_00100_SERVICIO_DE_BAJA_DEFINITIVA
            Cod_00120_ETIQUETAS_PARA_CAJAS
            Cod_00130_PRECINTOS_DE_SEGURIDAD
           
           
           Rem  ActualizarTangoDetalle "00010"
           rsFacturacion.MoveNext
        Loop
...
Public Function Control_Requerimientos_Digitales() As Boolean
    Dim Sql As String
    Dim RsDigital As New ADODB.Recordset
    Control_Requerimientos_Digitales = True
        ...
        RsDigital.Open Sql, strConBasa, 0, 1
         ...
         Do While Not RsDigital.EOF
            MsgBox " El Requerimiento " & RsDigital!IDREQUERIMIENTO & " NO Tiene cantidad de Imagenes Mofificar la fecha FECHA RECEPCION "
             Control_Requerimientos_Digitales = False
            RsDigital.MoveNext
         Loop
  End Function
...
Dim ConTango As New ADODB.Connection
Dim Sql As String
...
'conTango.Open strConTango
'Sql = " Update GVA48"
'Sql = Sql & " SET                LEYENDA_1 = NULL, LEYENDA_5 = NULL"
'conTango.Execute Sql


End Sub

Public Sub BaseTangoClientes()

        Dim rs As New ADODB.Recordset
        Dim rsClienteBasa As New ADODB.Recordset
        Dim rsPrecios As New ADODB.Recordset
        Dim rsModelos As New ADODB.Recordset
        Dim Sql As String
        Dim SqlA As String
        Dim SqlPrecios As String
        Dim SqlModelos As String
        
        Sql = " Update Clientes Set CLIENTE_BASE_TANGO = Null"
        ExecutarSql Sql
        
        SqlModelos = " SELECT     SUBSTRING ( CABEZERA_MODELO.COD_MODELO ,2,4) as COD_CLIENTE ,    CABEZERA_MODELO.ID_GVA48, CABEZERA_MODELO.COD_MODELO, CABEZERA_MODELO.DESC_MODEL, CABEZERA_MODELO.LEYENDA_1,"
        SqlModelos = SqlModelos & vbCrLf & " CABEZERA_MODELO.TALONARI_A, CABEZERA_MODELO.TALONARI_B, CABEZERA_MODELO.TALON_PED, RELACION_MODELO_CLIENTE.COD_CLIENT, CABEZERA_MODELO.N_LISTA"
        SqlModelos = SqlModelos & vbCrLf & " FROM GVA48 AS CABEZERA_MODELO LEFT OUTER JOIN"
        SqlModelos = SqlModelos & vbCrLf & " GVA49 AS RELACION_MODELO_CLIENTE ON CABEZERA_MODELO.COD_MODELO = RELACION_MODELO_CLIENTE.COD_MODELO"
        SqlModelos = SqlModelos & vbCrLf & " Where SUBSTRING(CABEZERA_MODELO.COD_MODELO, 1, 1) = 1"
        
            SqlModelos = " SELECT        SUBSTRING(CABEZERA_MODELO.COD_MODELO, 2, 4) AS COD_CLIENTE"
            SqlModelos = SqlModelos & vbCrLf & " FROM GVA48 AS CABEZERA_MODELO LEFT OUTER JOIN"
            SqlModelos = SqlModelos & vbCrLf & " GVA49 AS RELACION_MODELO_CLIENTE ON CABEZERA_MODELO.COD_MODELO = RELACION_MODELO_CLIENTE.COD_MODELO"
            SqlModelos = SqlModelos & vbCrLf & " Where (SUBSTRING(CABEZERA_MODELO.COD_MODELO, 1, 1) = 1)"
            SqlModelos = SqlModelos & vbCrLf & " GROUP BY SUBSTRING(CABEZERA_MODELO.COD_MODELO, 2, 4)"
        
        
        Set rsModelos = New ADODB.Recordset
        rsModelos.Open SqlModelos, strConTangoBasa
        Do While Not rsModelos.EOF
            BaseTangoClientesDetalle rsModelos!COD_CLIENTE, strConTangoBasa, "Basa"
            rsModelos.MoveNext
        Loop
        Set rsModelos = New ADODB.Recordset
        rsModelos.Open SqlModelos, strConTangoCustodia
        Do While Not rsModelos.EOF
            BaseTangoClientesDetalle rsModelos!COD_CLIENTE, strConTangoCustodia, "Custodia"
            rsModelos.MoveNext
        Loop
...
Public Sub BaseTangoClientesDetalle(COD_CLIENTE As Integer, strBaseConexion As String, strEmpresa As String)
        Dim rsPrecios As New ADODB.Recordset
        Dim Sql As String
        Dim SqlPrecios As String
            
            Sql = " Update Clientes SET CLIENTE_BASE_TANGO = '" & strEmpresa & "'"
            Sql = Sql & " Where id_cliente = " & COD_CLIENTE
            ExecutarSql Sql
            SqlPrecios = " SELECT GVA10.NRO_DE_LIS AS CODIGO_CLIENTE_LISTA, GVA10.NOMBRE_LIS AS RAZON_SOCIAL, GVA17.COD_ARTICU AS CODIGO_ARTICULO,"
            SqlPrecios = SqlPrecios & vbCrLf & " STA11.DESCRIPCIO AS DESCRIPCION_ARTICULO,  STA11.DESC_ADIC as DESCRIPCION_ADICIONAL,CONVERT (smallmoney, GVA17.PRECIO) as PRECIOS"
            SqlPrecios = SqlPrecios & vbCrLf & " FROM GVA10 INNER JOIN"
            SqlPrecios = SqlPrecios & vbCrLf & " GVA17 ON GVA10.NRO_DE_LIS = GVA17.NRO_DE_LIS INNER JOIN"
            SqlPrecios = SqlPrecios & vbCrLf & " STA11 ON GVA17.COD_ARTICU = STA11.COD_ARTICU"
            SqlPrecios = SqlPrecios & vbCrLf & " WHERE GVA10.NRO_DE_LIS = " & COD_CLIENTE
            SqlPrecios = SqlPrecios & vbCrLf & " ORDER BY CODIGO_CLIENTE_LISTA, CODIGO_ARTICULO"
            Set rsPrecios = New ADODB.Recordset
            rsPrecios.Open SqlPrecios, strBaseConexion
            Do While Not rsPrecios.EOF
                SqlPrecios = " INSERT INTO FACTURACION_TANGO("
                SqlPrecios = SqlPrecios & vbCrLf & " ID_PROCESO "
                SqlPrecios = SqlPrecios & vbCrLf & ", TITULO "
                SqlPrecios = SqlPrecios & vbCrLf & ", COD_CLIENTE"
                SqlPrecios = SqlPrecios & vbCrLf & ", STA11_COD_ARTICU"
                SqlPrecios = SqlPrecios & vbCrLf & ", STA11_DESCRIPCIO"
                SqlPrecios = SqlPrecios & vbCrLf & ", CANTIDAD "
                SqlPrecios = SqlPrecios & vbCrLf & ",GRUPO"
                SqlPrecios = SqlPrecios & ")"
                SqlPrecios = SqlPrecios & " VALUES  ("
                SqlPrecios = SqlPrecios & vbCrLf & "'" & ID_Proceso & "'"
                SqlPrecios = SqlPrecios & vbCrLf & ",'" & TITULO_SQL & "'"
                SqlPrecios = SqlPrecios & vbCrLf & "," & COD_CLIENTE
                SqlPrecios = SqlPrecios & vbCrLf & ",'" & Trim(rsPrecios!CODIGO_ARTICULO) & "'"
                SqlPrecios = SqlPrecios & vbCrLf & ",'" & Trim(rsPrecios!DESCRIPCION_ARTICULO) & "'"
                SqlPrecios = SqlPrecios & vbCrLf & ",'" & FormatNumber(rsPrecios!PRECIOS, 2) & "'"
                SqlPrecios = SqlPrecios & vbCrLf & ",0"
                SqlPrecios = SqlPrecios & ")"
                ExecutarSql SqlPrecios
                SqlPrecios = "Insert Into FACTURACION_DETALLE_TANGO("
                SqlPrecios = SqlPrecios & vbCrLf & " ID_PROCESO "
                SqlPrecios = SqlPrecios & vbCrLf & ", COD_CLIENTE"
                SqlPrecios = SqlPrecios & vbCrLf & ", STA11_COD_ARTICU"
                SqlPrecios = SqlPrecios & vbCrLf & ",GRUPO"
...
Public Sub Cod_00030_HORAS_DE_ARCHIVISTAS_EN_PLANTA()
Dim Sql As String
    Dim rs As ADODB.Recordset
    Dim Cantidad_Horas_Totales As Integer
                ...
                Sql = " SELECT REQUERIMIENTO.IDREQUERIMIENTO, TIPOREQUERIMIENTO.DESCRIPCION as  TIPO_REQUERIMIENTO_DESCRIPCION , REQUERIMIENTO.IDTIPOREQUERIMIENTO as IDTIPOREQUERIMIENTO , REQUERIMIENTO.FECHARECEPCION,  HORA_ARCHIVISTA , CANTIDAD "
                Sql = Sql & vbCrLf & " FROM  REQUERIMIENTO LEFT OUTER JOIN"
                Sql = Sql & vbCrLf & " TIPOREQUERIMIENTO ON REQUERIMIENTO.IDTIPOREQUERIMIENTO = TIPOREQUERIMIENTO.IDTIPOREQUERIMIENTO"
                Sql = Sql & vbCrLf & " WHERE ID_CLIENTE =  " & COD_CLIENTE
                Sql = Sql & vbCrLf & " AND REQUERIMIENTO.IDTIPOREQUERIMIENTO in (13 , 19 ) "
                Sql = Sql & vbCrLf & " AND (ANULADO IS NULL)"
                Sql = Sql & vbCrLf & " AND  FECHARECEPCION Between " & FechaFormato(FECHA_INICIO)
                Sql = Sql & vbCrLf & " AND " & FechaFormato(FECHA_FIN)
                Sql = Sql & vbCrLf & " ORDER BY TIPOREQUERIMIENTO.DESCRIPCION, REQUERIMIENTO.IDREQUERIMIENTO"
 ...
 Cantidad_Horas_Totales = 0
                Do While Not rs.EOF
                        ...
                        Sql = Sql & vbCrLf & "'" & ID_Proceso & "'"
                        Sql = Sql & vbCrLf & "," & COD_CLIENTE
                        Sql = Sql & vbCrLf & ",'00030'"
                        Sql = Sql & vbCrLf & ",'" & Trim(rs!IDREQUERIMIENTO) & "'"
                        Sql = Sql & vbCrLf & ",'REQUERIMIENTO'"
                        If (rs!IDTIPOREQUERIMIENTO) = 13 Then
                         If (rs!HORA_ARCHIVISTA) > 0 Then
                            Sql = Sql & vbCrLf & "," & rs!HORA_ARCHIVISTA
                            Cantidad_Horas_Totales = Cantidad_Horas_Totales + rs!HORA_ARCHIVISTA
                          Else
                            Sql = Sql & vbCrLf & ",0"
                          End If
                        End If
                         If (rs!IDTIPOREQUERIMIENTO) = 19 Then
                            If (rs!Cantidad) > 0 Then
                                Sql = Sql & vbCrLf & "," & rs!Cantidad
                                Cantidad_Horas_Totales = Cantidad_Horas_Totales + rs!Cantidad
                            Else
                                Sql = Sql & vbCrLf & ",0"
                            End If
                        End If
    ...
    If Cantidad_Horas_Totales <> 0 Then
    ...
    Sql = Sql & vbCrLf & "," & COD_CLIENTE
    Sql = Sql & vbCrLf & ",'00030'"
    Sql = Sql & vbCrLf & ", 'HORAS DE ARCHIVISTAS EN PLANTA'"
    Sql = Sql & vbCrLf & "," & Cantidad_Horas_Totales
    Sql = Sql & ",1"
    Sql = Sql & ")"
    ExecutarSql Sql
